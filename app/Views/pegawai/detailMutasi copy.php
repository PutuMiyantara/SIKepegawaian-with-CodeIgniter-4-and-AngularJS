                            ...
                            <tr ng-repeat="d in datas">
                                ...
                                <td>
                                    <button type="submit" class="btn btn-danger"
                                        ng-click="deleteMutasi(d.id_mutasi_pegawai, d.id_pegawai)"><i
        ...
        <div class="modal fade" tabindex="1" role="dialog" id="detailMutasiPeg">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="POST" name="formMutasi" id="formTambahMutasiPeg" ng-submit="updateMutasi()">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <small style="color: red;"
                                    ng-show="formMutasi.tgl_mutasi.$dirty && formMutasi.tgl_mutasi.$invalid">Masukan
                                    Angka</small>
